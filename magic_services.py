...
# Source: http://dndspeak.com/2020/01/100-unique-magical-services/
table = [
    (
    ...
    ("Magical Teleportation. Teleport where you need to go.", 1),
    ("TelEx. Teleport Express will deliver your items wherever you need overnight.", 1),
    (
    ...
    ("A wizard who casts fly on people who pay and want to fly.", 1),
    ("A wizard who uses Major Image to recreate a scenario or for a play.", 1),
    ("Merlo’s Moving Company – uses Mage Hand and Telekinesis to move your boxes.", 1),
    ("Restaurant that uses magic to create catered food for events.", 1),
    (
    ...
    ("High level cleric that casts commune on your behalf.", 1),
    (
        "Fire Brigade – mages that use magic to put out fires & rescue people trapped in fires.",
        1,
    ),
    ("Lamplighter – mage that uses magic to light streetlamps in towns & cities.", 1),
    (
    ...
    ("Sculptors – mages that use shape stone to create their works.", 1),
    (
        "Weather Mage – providing rain for farmers & guaranteed good weather for outside events.",
        1,
    ),
    ("Wind Mage – speeds up sea travel by providing a constant wind.", 1),
    (
    ...
    ("Smells By Design – magical perfumes.", 1),
    ("Better Friends – they will cast awaken on your pets. No guarantees.", 1),
    (
    ...
    ("Earwax Removal using a very small Mage Hand.", 1),
    ("Flood Cleanup using Telekinesis and Mage Hand.", 1),
    ("Dog Walking using Mage Hand.", 1),
    ("Magical beast walking/pet sitting.", 1),
    (
    ...
    ("Clothing mender uses magic to repair and tailor clothes.", 1),
    (
    ...
    ("Tunneling & Mining – Mages with shape earth & shape stone.", 1),
    (
    ...
    ("Soul Jars – keep the soul of whoever you like in a jar. No questions asked.", 1),
    (
